...
the current standards for dynamic CECT acquisition and their impact to 
future multiphasic CT-based radiomics studies.
Finally we present ways to incorporate our work in other DLR-liver related 
studies, by encouraging for the creation of open and precisely 
annotated CECT datasets.
...
positives (FP) filtering method to reduce the number of
...
have a sufficient amount of CT images correctly labeled), before
