...
\begin{figure}[!ht]
	\begin{mdframed}[backgroundcolor=blue!50,linecolor=blue!50]
		...
		\end{minipage} \\
	\end{mdframed}
	\caption{Example of tumor characteristic imaging traits present in both training and test datasets. Left: \textbf{\lmttfont{G-dB}} images, right: \textbf{\lmttfont{TCIA-dB}} images. \textbf{TODO}.}
...
\begin{figure}[!ht]
	\begin{mdframed}[backgroundcolor=blue!50,linecolor=blue!50]
		...
		\end{minipage}
	\end{mdframed}
	\caption{Example of tumor characteristic imaging traits present in both training and test datasets. Left: \textbf{\lmttfont{G-dB}} images, right: \textbf{\lmttfont{TCIA-dB}} images. Wash-in/Wash-out.}
