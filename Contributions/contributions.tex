...
liver and its tumors. We also proved that incorporating the dynamic information through the use of contrast-enhanced images can improve the performances of the network thanks to the specific wash-in wash-out mechanism. Finally, we proved the ability of our cascaded architecture to provide additional annotations in weakly annotated datasets.
...
delineate \ac{hcc} on multiphase \ac{ct} images using a \ac{dl} architecture.
...
\begin{figure}[th!]
	\centering
	\includegraphics[width=0.7\linewidth]{../SemanticSeg/images/image26}
...
Example of an image from the \textbf{\lmttfont{TCIA-dB}}, with the obtained predicted tumor
