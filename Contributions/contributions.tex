...
\chapter{Semantic segmentation applied to the study of HCC} \label{chapter:IJCARS}
...
signed paired rank tests, since slice-wise \ac{dsc}s did not follow a normal distribution. We used the DSC as a metric to compare the models since it is one of the most commonly used metric for the semantic segmentation task (other metrics can be found in the appendix \ref{appendix---Evaluation Metric}).
...
\begin{figure}[!ht]
	\centering
	\begin{minipage}{4cm}
		\includegraphics[width=\linewidth]{images/ResizeNecrosisVE_Raw_Pat0_8}
	\end{minipage} \hspace{-0.3cm}
	\begin{minipage}{4cm}
		\includegraphics[width=\linewidth]{images/ResizeNecrosisVE_GT_Pat0_8}
	\end{minipage} \hspace{-0.3cm}
	\begin{minipage}{4cm}
		\includegraphics[width=\linewidth]{images/ResizeNecrosisVE_Pred_Pat0_8}
	\end{minipage} \\
	\begin{minipage}{4cm}
		\includegraphics[width=\linewidth]{images/ResizeNecrosisVE_Raw_Pat0_13}
	\end{minipage} \hspace{-0.3cm}
	\begin{minipage}{4cm}
		\includegraphics[width=\linewidth]{images/ResizeNecrosisVE_GT_Pat0_13}
	\end{minipage} \hspace{-0.3cm}
	\begin{minipage}{4cm}
		\includegraphics[width=\linewidth]{images/ResizeNecrosisVE_Pred_Pat0_13}
	\end{minipage} 
...
We concluded that the combination of multiphase registered images used in a cascaded architecture allows us to automatically perform the semantic segmentation of liver tissues. \\
